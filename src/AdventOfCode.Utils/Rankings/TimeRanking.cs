...
public sealed record TimeRanking(Participant Participant, int Year) : IComparable<TimeRanking>
{
    ...
    public int CompareTo(TimeRanking other) => other.Score.CompareTo(Score);
