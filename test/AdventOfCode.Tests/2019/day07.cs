...
namespace Advent_of_Code_2019
{
    public class day07
    {
        ...
        public void part_one()
        {
            ...
            Puzzle.HasAnswer(101490, Day07.One, with: input);
        }

        [Test]
        public void part_two_example_1()
        {
            var program = Intcode.Parse("3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5");
            Assert.AreEqual(139629729, Day07.AmplifyWithFeedback(program, 9, 8, 7, 6, 5));
        }

        [Test]
        public void part_two_example_2()
        {
            var program = Intcode.Parse("3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,-5,54,1105,1,12,1,53,54,53,1008,54,0,55,1001,55,1,55,2,53,55,53,4,53,1001,56,-1,56,1005,56,6,99,0,0,0,0,10");
            Assert.AreEqual(18216, Day07.AmplifyWithFeedback(program, 9, 7, 8, 5, 6));
        }
        ...
        {
            var input = Input.For(2019, 07);
            Puzzle.HasAnswer(61019896, Day07.Two, with: input);
        }
    }
}
